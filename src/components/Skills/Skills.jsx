...
//         <div
//           key={category.title}
//           className="bg-gray-900 backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 w-full sm:w-[48%] lg:w-[40%] xl:w-[32%] rounded-2xl border border-white 
...
//                 gyroscope={true}
//               >
//                 <div className="flex flex-col items-center justify-center bg-transparent border-2 border-gray-700 rounded-2xl py-3 px-2 hover:shadow-md transition">
//                   <img
//                     src={skill.logo}
//                     alt={`${skill.name} logo`}
